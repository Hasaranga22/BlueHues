    ...
    return (
        <footer className="bg-slate-950 text-slate-200">
            <div className="max-w-7xl mx-auto px-6 py-10 md:py-14">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 border-b border-slate-800 pb-8">
                    {/* Brand block with logo */}
                    <div className="flex gap-4 items-start">
                        <a href="#top" className="flex items-center gap-3">
                            <img src="/images/BlueHuesLogo.png" alt="BlueHues" className="h-10 w-auto object-contain" />
                        </a>
                        <div>
